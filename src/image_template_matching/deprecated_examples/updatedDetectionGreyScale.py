...
class TemplateMatcher:
    ...
    def process_frame(self, frame, orb):
        ...
        # Apply edge detection and get bounding boxes
        edges, bounding_boxes = self.edge_detection(gray)

        # Highlight edges in the original frame
        ...
        if len(good_matches) > 30:  # Increased threshold for good matches
            ...
            cv2.rectangle(frame_matches, (x_min, y_min), (x_max, y_max), (255, 0, 0), 3)
    ...
    def load_and_use_parameters(self):
        ...
        with open('../best_orb_params.json', 'r') as f:
            params = json.load(f)
